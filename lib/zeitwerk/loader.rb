...
module Zeitwerk
  class Loader
    ...
    def unload
      mutex.synchronize do
        # We are going to keep track of the files and directories that were
        # required by our autoloads to later remove them from $LOADED_FEATURES,
        # thus making them loadable by Kernel#require again.
